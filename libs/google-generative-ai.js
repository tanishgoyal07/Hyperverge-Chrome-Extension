// /*
//  * Skypack CDN - @google/generative-ai@0.16.0
//  *
//  * Learn more:
//  *   📙 Package Documentation: https://www.skypack.dev/view/@google/generative-ai
//  *   📘 Skypack Documentation: https://www.skypack.dev/docs
//  *
//  * Pinned URL: (Optimized for Production)
//  *   ▶️ Normal: https://cdn.skypack.dev/pin/@google/generative-ai@v0.16.0-jWmCEWgfXHMZwSvdk2Yd/mode=imports/optimized/@google/generative-ai.js
//  *   ⏩ Minified: https://cdn.skypack.dev/pin/@google/generative-ai@v0.16.0-jWmCEWgfXHMZwSvdk2Yd/mode=imports,min/optimized/@google/generative-ai.js
//  *
//  */

// // Browser-Optimized Imports (Don't directly import the URLs below in your application!)
// export * from '/-/@google/generative-ai@v0.16.0-jWmCEWgfXHMZwSvdk2Yd/dist=es2019,mode=imports/optimized/@google/generative-ai.js';
// export {default} from '/-/@google/generative-ai@v0.16.0-jWmCEWgfXHMZwSvdk2Yd/dist=es2019,mode=imports/optimized/@google/generative-ai.js';


/**
 * Bundled by jsDelivr using Rollup v2.79.1 and Terser v5.19.2.
 * Original file: /npm/@google/generative-ai@0.16.0/dist/index.mjs
 *
 ...
 * limitations under the License.
 */
const P=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],$={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y{constructor(t){this.apiKey=t}getGenerativeModel(t,e){if(!t.model)throw new u("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new K(this.apiKey,t,e)}getGenerativeModelFromCachedContent(t,e){if(!t.name)throw new g("Cached content must contain a `name` field.");if(!t.model)throw new g("Cached content must contain a `model` field.");const n={model:t.model,tools:t.tools,toolConfig:t.toolConfig,systemInstruction:t.systemInstruction,cachedContent:t};return new K(this.apiKey,n,e)}}export{r as BlockReason,B as ChatSession,e as ExecutableCodeLanguage,c as FinishReason,l as FunctionCallingMode,t as FunctionDeclarationSchemaType,K as GenerativeModel,Y as GoogleGenerativeAI,u as GoogleGenerativeAIError,f as GoogleGenerativeAIFetchError,g as GoogleGenerativeAIRequestInputError,h as GoogleGenerativeAIResponseError,i as HarmBlockThreshold,o as HarmCategory,a as HarmProbability,n as Outcome,s as POSSIBLE_ROLES,d as TaskType};export default null;
//# sourceMappingURL=/sm/a90d169d154b68162d5887e6347b2171ca37e7b65042f399dc4f44b8992e6d2b.map
